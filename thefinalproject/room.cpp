...
QSqlQueryModel* room::displayroom()
{
    ...
    QSqlQueryModel* model = new QSqlQueryModel();
              ...
              model->setHeaderData(3, Qt::Horizontal, QObject::tr("ROOM_NUMBER"));
              model->setHeaderData(4, Qt::Horizontal, QObject::tr("ROOM_TYPE"));
              model->setHeaderData(5, Qt::Horizontal, QObject::tr("creation_date"));
              model->setHeaderData(2, Qt::Horizontal, QObject::tr("room_state"));
